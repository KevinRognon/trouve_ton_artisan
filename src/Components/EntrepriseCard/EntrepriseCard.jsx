...
export default function EntrepriseCard (props) {
    ...
    return (
        <NavLink to={`/entreprise/${props.entreprise_nom}`} className="entreprise-card d-flex flex-column justify-content-center align-items-center gap-1 card p-3 shadow col-12 col-md-4 text-center">
