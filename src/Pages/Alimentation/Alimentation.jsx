...
export default function Alimentation () {
    ...
    return (
        <>
            <Meta title="Entreprises d'alimentation" content="Trouvez votre entreprise d'alimentation sur cette page" />
            <section className="d-flex flex-column align-items-center">
                <article className="d-flex flex-column justify-content-center align-items-center">
                    <h1 className="text-dark text-center">Entreprises d'Alimentation</h1>
